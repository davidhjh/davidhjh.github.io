var coll = Array.from(document.getElementsByClassName("collapsible-experience"));
coll = coll.concat(Array.from(document.getElementsByClassName("collapsible-education")));
var i;
